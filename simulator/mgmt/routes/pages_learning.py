...
def learning_aircrackng():
    return render_template(
        "pages/learning/aircrack-ng.html", section="learning", current_page="aircrack-ng"
    )
...
def learning_wireshark():
    return render_template(
        "pages/learning/wireshark.html", section="learning", current_page="wireshark"
    )
...
def learning_mavlink():
    return render_template(
        "pages/learning/mavlink.html", section="learning", current_page="mavlink"
    )
...
def learning_mavproxy():
    return render_template(
        "pages/learning/mavproxy.html", section="learning", current_page="mavproxy"
    )
...
def learning_ardupilot():
    return render_template(
        "pages/learning/ardupilot.html", section="learning", current_page="ardupilot"
    )
...
def learning_arducopter():
    return render_template(
        "pages/learning/arducopter.html", section="learning", current_page="arducopter"
    )
...
def learning_swarmsec():
    return render_template(
        "pages/learning/swarmsec.html", section="learning", current_page="swarmsec"
    )
